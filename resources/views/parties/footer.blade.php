            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-12 col-md-6">
                            <div class="footer-widget about-widget">
                                <h6 class="widget-title">@lang("infos.main_menu.about")</h6>
                                <div class="text">
                                   @lang("infos.txtFooter")
                ...
                <div class="footer-column col-xl-3 col-lg-6 col-md-6 col-sm-12">
                    <div class="footer-widget contacts-widget">
                        ...
                        <div class="text"> 16, avenue de la paix, Kinshasa-Gombe, @lang("infos.ref") : Pressing 5 à sec.</div>
                            ...
                            <div class="subscribe-form">
                                ...
                                <form method="post" action="{{ route('sendNewslestter') }}" id="newsletter">
                                    ...
                                    <div class="form-group">
                                        <input type="email" name="email" class="email" value="" placeholder="@lang('infos.contactform.email')" required="">
                                        <button type="submit" class="theme-btn" id="btnNews"><span class="btn-title"><i class="fa fa-paper-plane"></i></span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <div class="auto-container">
            <div class="inner-container">
                <div class="copyright-text">
                    <p>@lang("infos.all_right_reserved") &copy; Copyright 2023 TBG, Design by <a href="silasmas.com">SDev</a></p>
                </div>
            </div>
        </div>
    </div>
