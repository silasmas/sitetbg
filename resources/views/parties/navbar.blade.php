{{-- <header id="site-header" class="main-header main-header-overlay" data-sticky-header="true"
                ...
                <div class="w-25percent flex items-center justify-end lg:hidden">
                    ...
                    <div class="module-btn px-0/5em">
                        <a href="#contact-modal"
                            class="btn btn-solid btn-md text-13 font-bold tracking-1/5 leading-1/4em bg-white rounded-100 shadow-md text-blue-700 hover:text-white"
    ...
    <section
        class="lqd-section lqd-stickybar-wrap lqd-stickybar-left link-black link-medium pt-100 pb-25 bg-transparent pointer-events-none md:hidden">
        <div class="static w-full h-full flex items-center justify-between flex-grow-1 vertical-lr">
            <div class="w-full flex items-center flex-grow-1 justify-start p-10">
                <div
                    class="lqd-fancy-menu lqd-menu-td-none static w-full header-module header-module-rotate pb-10 flex items-center -rotate-180">
            ...
            <div class="w-full flex items-center justify-center flex-grow-1 p-10">
                <span class="-rotate-180 pointer-events-auto pt-70 pb-10 text-black font-medium"
                    data-lqd-interactive-color="true">Contact@thebestgroup.org</span>
            </div>
            <div class="w-full flex items-center flex-grow-1 justify-center p-10">
                <div class="lqd-scrl-indc header-module header-module-rotate flex -rotate-180 pointer-events-auto"
                    data-lqd-scroll-indicator="true">
                    <a href="#wrap" data-localscroll="true" data-lqd-interactive-color="true"><span
                            class="lqd-scrl-indc-inner flex items-center text-inherit">
                            <span class="lqd-scrl-indc-txt">scroll</span> <span
                                class="lqd-scrl-indc-line w-1 h-60 relative text-inherit bg-black-30"><span
                                    class="lqd-scrl-indc-el absolute -top-5 -left-5 rounded-8 inline-block w-10 h-10 bg-current-color"
                                    style="transform: translate(0px);"></span></span></span></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="nav-outer">
            <nav class="navbar main-menu nav">
                <ul class="navigation">
                    ...
                    <li><a href="{{Route::current()->getName()==" accueil"?"#home":route('accueil') }}"
                            class="nav-link active" aria-current="page">@lang("infos.main_menu.home")</a></li>
                    <li><a href="{{Route::current()->getName()==" accueil"?"#services":route('accueil') }}"
                            class="nav-link">@lang("infos.main_menu.services")</a></li>
                    <li><a href="{{Route::current()->getName()==" accueil"?"#about":route('accueil') }}"
                            class="nav-link">@lang("infos.main_menu.about")</a></li>
                    <li><a href="{{Route::current()->getName()==" accueil"?"#portfolio":route('accueil') }}"
                            class="nav-link">@lang("infos.main_menu.portfolio")</a></li>
                    <li><a href="{{Route::current()->getName()==" accueil"?"#team":route('accueil') }}"
                            class="nav-link">@lang("infos.main_menu.team")</a></li>
                    <li><a href="{{Route::current()->getName()==" accueil"?"#contact":route('accueil') }}"
                            class="nav-link">@lang("infos.main_menu.contact")</a></li>
                    {{-- @else
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            ...
            <ul class="social-links">
                ...
                <li><a href="https://youtube.com/channel/UC3lltuUYIdE-i_bfkLUB3UQ"><i class="fab fa-youtube"></i></a>
                </li>
                <li><a href="https://instagram.com/thebestgroupdrc?igshid=q9yqj3mr3bn5"><i
