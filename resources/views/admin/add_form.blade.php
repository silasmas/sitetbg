                    ...
                    <div class="col-md-12" id="tab-porto">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-md-12">
                                            <form  role="form" id="formTemoignage"  method="POST" action="{{route('add.form')}}" class='form-group' enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-md-6">
                                                            <label>Grand titre</label>
                                                            <input type="text" placeholder="Enter le grand titre" name='grandtitre' value="{{ old('grandtitre') }}" class="form-control">
                                                    ...
                                                    <div class="col-md-6">
                                                            ...
                                                            <input type="date" name='date_debut' placeholder="Date debut" value='{{old('date_debut') }}' class="form-control">

                                                    </div>
                                                    <div class="col-md-6">
                                                            <label>Date fin</label>
                                                            <input type="date" name='date_fin' placeholder="Date fin" value='{{old('date_fin') }}' class="form-control">

                                                    </div>
                                                    <div class=" col-md-6"><label>Lien de paiement (Si l'event est paynt)</label>
                                                        <input type="text" name='lienPaiement' placeholder="Smallt Titre" class="form-control">
                                                 </div>
                                                    ...
                                                    <div class="col-md-6">
                                                            ...
                                                            <span class="input-group-addon btn btn-default btn-file"><span
                                                                ...
                                                                <span class="fileinput-exists">Changer</span><input type="file" name="visuelpaiement"></span>
                                                    ...
                                                    <div class="col-md-6">
                                                            ...
                                                            <span class="input-group-addon btn btn-default btn-file"><span
                                                                class="fileinput-new">Selectioner une photo</span>
                                                                <span class="fileinput-exists">Changer</span><input type="file" name="banniere"></span>
                                                            <a href="#" class="input-group-addon btn btn-default fileinput-exists"
                                                                data-dismiss="fileinput">Supprimer</a>
                                                            </div>
                                                    </div>
